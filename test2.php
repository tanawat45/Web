                ...
                <form class="form-horizontal" role="form" action="add/addregister.php" method="POST"  enctype="multipart/form-data">    
                    <div class="col-sm-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 form-group" >
                                <label for="lastName">นามสกุล(ภาษาอังกฤษ)<font color="red"> *</font></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 form-group" >
                                <label for="essn">เลขบัตรประชาชน/passport<font color="red"> *</font></label>
                                <input type="id" name="essn" placeholder="1549900XXXXXX" class="form-control" required minlength="7" maxlength="13" id = "pass1">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 form-group" >
                                <label for="nationality">สัญชาติ<font color="red"> *</font></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 form-group" >
                                <label for="address">ที่อยู่<font color="red"> *</font></label>
                                <input type="text" name="address" placeholder="111/1 หมู่ 1 ต.สุเทพ อ.เมือง จ.เชียงใหม่" class="form-control" autofocus required id = "txt" onkeyup = "Validate(this)">
                            </div>
                        </div>	
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 form-group" >
                                <label for="postcode">รหัสไปรษณีย์<font color="red"> *</font></label>
                                <input type="text" name="postcode" placeholder="50300" class="form-control" autofocus required id="postcode" maxlength="5" onkeyup="validatephone(this);">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 form-group" >
                                <label for="Emergency number">เบอร์ติดต่อกรณีฉุกเฉิน<font color="red"> *</font></label>
                                <input type="text" name="emergency_contact_phone" placeholder="08X-XXXXXXX" class="form-control" autofocus required id="phone" maxlength="10" onkeyup="validatephone(this);">
                            </div>
                        </div>	
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 form-group" >
                                <label for="allergic_drug">การแพ้ยา</label>
                                <input type="text" name="allergic_drug" placeholder="แพ้ยาแก้แพ้" class="form-control" autofocus>
                            </div>
                        </div>	
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 form-group" >
                                <label for="blood">กรุ๊ปเลือด<font color="red"> *</font></label>
                                <div>
