...
<script src="javascript/payment.js"></script>
	...
	<div class="row">
        <div class="col-md-3 col-sm-6 col-xs-6">
            <ul class="nav setup-panel">
                <li class="">
                    <a href="#step-1"><button class="btn list-group-item-heading">รายละเอียด</button></a>
                </li>
            </ul>        
        </div>
        <div class="col-md-3 col-sm-6 col-xs-6">
        ...
        <div class="col-md-3 col-sm-6 col-xs-6">
            <ul class="nav setup-panel">
                <li class="active">
                    <a href="#step-3"><button class="btn3 list-group-item-heading">รายชื่อนักวิ่ง</button></a>
                </li>
            </ul>       
        </div>
	</div>
    ...
    <div class="row setup-content" id="step-2">
        <div class="col-xs-12" style="margin-bottom:100px;border-left-width:100px;border-right-width:100px;margin-top:20px;">
            <div class="">
            <center><h2><u>แผนที่</u></h2><br><img src="<?=$row["map"]?>" style="width:600px; height:500px" class="img-responsive"></center>
